...
@section('title', 'Active Cases Report')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                View and analyze currently running treatment cases.
        ...
        <div class="d-flex gap-2 mt-3 mt-md-0">
            ...
            <a
                href="{{ route(
                    'admin.reports.active-cases.export.excel',
                    request()->query()
                ) }}"
            ...
            <a
                href="{{ route(
                    'admin.reports.active-cases.export.pdf',
                    request()->query()
                ) }}"
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <h4 class="fw-bold mb-0">
                        ...
                        {{ number_format($summary['installment_cases']) }}
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <h4 class="fw-bold mb-0">
                        ...
                        {{ number_format($summary['full_payment_cases']) }}
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <h4 class="fw-bold mb-0 text-danger">
                        ...
                        {{ number_format($summary['overdue_cases']) }}
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <form
                method="GET"
                action="{{ route('admin.reports.active-cases.index') }}"
            >
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        >
                            ...
                            @foreach($filters['installment_options'] as $value => $label)

                                <option
                                    value="{{ $value }}"
                                    @selected(request('is_installment') === (string) $value)
                                >
