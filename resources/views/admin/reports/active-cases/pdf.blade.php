...
<body>
    ...
    <div class="header">
        ...
        <p>
            Currently running treatment cases
        </p>
    ...
    @if(
        ...
        $filters['is_installment'] !== null && $filters['is_installment'] !== '' ||
            ...
            <tr>
                ...
                <td style="font-size:8px;">
                    ...
                    @if(!empty($filters['payment_method']))
                        Payment Method:
                        {{ ucwords(str_replace('_', ' ', $filters['payment_method'])) }}
                        |
                    @endif
    ...
    <div class="footer">
        ...
        Active Cases Report &bull; DentLab-OS
