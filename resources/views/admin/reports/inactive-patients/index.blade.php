...
@section('title', 'Inactive Patients Report')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                View and analyze currently inactive patient records.
        ...
        <div class="d-flex gap-2 mt-3 mt-md-0">
            ...
            <a
                href="{{ route('admin.reports.inactive-patients.export.excel', request()->query()) }}"
            ...
            <a
                href="{{ route('admin.reports.inactive-patients.export.pdf', request()->query()) }}"
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <form
                method="GET"
                action="{{ route('admin.reports.inactive-patients.index') }}"
            >
