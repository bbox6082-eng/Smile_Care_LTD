...
@section('title', 'Active Patients Report')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                View and analyze currently active patient records.
        ...
        <div class="d-flex gap-2 mt-3 mt-md-0">
            ...
            <a
                href="{{ route('admin.reports.active-patients.export.excel', request()->query()) }}"
            ...
            <a
                href="{{ route('admin.reports.active-patients.export.pdf', request()->query()) }}"
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <form
                method="GET"
                action="{{ route('admin.reports.active-patients.index') }}"
            >
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-6 d-flex align-items-end gap-2">
                        ...
                        <a
                            href="{{ route('admin.reports.active-patients.index') }}"
            ...
            <div class="row g-4 text-center">
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="fw-bold text-secondary mb-0 mt-1">
                        ...
                        {{ number_format(
                            $summary['zirconia_patients']
                            + $summary['others_patients']
                        ) }}
