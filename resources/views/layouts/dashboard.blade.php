...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul class="nav flex-column mb-0">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.mrs*') ? 'active' : '' }}" href="{{ route('admin.mrs.index') }}">
                    <i class="fas fa-user-tie me-2"></i> Marketing Representatives
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.payments*') ? 'active' : '' }}" href="{{ route('admin.payments.index') }}">
                    <i class="fas fa-credit-card me-2"></i> Case Management
                </a>
            </li>
        ...
        <div class="sidebar-footer">
            <form method="POST" action="{{ route('logout') }}" class="mb-0">
                @csrf
                <button type="submit" class="nav-link border-0 bg-transparent text-start w-100 text-white py-2">
