...
class AdminCartController extends Controller
{
    public function index()
    {
        ...
        return view('admin.inventory.cart', compact('cart'));
    }
    ...
    public function confirm()
    {
        ...
        return redirect()->route('admin.cart.confirmed')->with('success', 'Cart confirmed successfully.');
    }
    ...
    public function confirmedList()
    {
        ...
        return view('admin.inventory.confirmed', compact('carts'));
    }
}
